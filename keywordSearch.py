...
def signIn():
    ...
    #div = driver.find_element(By.CSS_SELECTOR,('div[id="container"]'))
...
def getData():
    ...
    time.sleep(3)
    input_box =driver.find_element(By.CSS_SELECTOR,('input[name="searchBoxInput"]'))
